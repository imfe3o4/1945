<template>
    <div class="views-xinlizhenliaofangan-add">
        <div>
...
<script setup>
    ...
    import { useXinlizhenliaofanganCreateForm, canXinlizhenliaofanganInsert } from "@/module";
    ...
    const { form, readMap } = useXinlizhenliaofanganCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canXinlizhenliaofanganInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {

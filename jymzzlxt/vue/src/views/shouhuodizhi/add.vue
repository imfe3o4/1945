<template>
    <div class="views-shouhuodizhi-add">
        <div>
...
<script setup>
    ...
    import { useShouhuodizhiCreateForm, canShouhuodizhiInsert } from "@/module";
    ...
    const { form } = useShouhuodizhiCreateForm();
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canShouhuodizhiInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {

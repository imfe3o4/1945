                                    ...
                                    <dd class="pay-channel" id="pay-channel">
                                        <div class="ep-pay-method-list-tit">
                                            <ul>
                                                ...
                                                <li
                                                    v-if="$route.query.bank && !isShaxiang"
                                                    :class="{selected:form.payType == 'bank'}"
                                                    title="余额支付"
                                                    @click="selectPayType('bank')"
                                                >
                                        ...
                                        <div class="ep-pay-operate">
                                            <a data-action="delay" href="javascript:void(0);" @click="payment()" title="立即支付" class="ep-btn ep-btn-blue">立即支付</a>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                isShaxiang: this.$route.query.isShaxiang || false,
            };
        },
        watch: {},
        computed: {},
        methods: {
            shaxiang() {
                ...
                var newWin = window.open(formatImageSrc(url) + link + Qs.stringify(this.form), "_blank");
            ...
            payment() {
                ...
                this.loading = true;
                this.$get("/api/payment", this.form)
                    .then((res) => {
                        this.loading = false;
                        if (res.code == 0) {

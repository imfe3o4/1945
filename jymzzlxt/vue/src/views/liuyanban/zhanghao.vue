        ...
        <div>
            <el-card class="box-card">
                ...
                <el-table border :data="lists" style="width: 100%" @sort-change="sortChange" highlight-current-row>
                    ...
                    <el-table-column prop="zixunrenxingming" label="咨询人姓名" width="130">
                        <template #default="{row}"> {{ row.zixunrenxingming }} </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="liuyanren" label="留言人" width="180">
                        ...
                        <template #default="{row}">
                            <el-button-group>
                                <el-tooltip effect="dark" content="编辑" placement="top-start"
                                    ><el-button type="success" :icon="Edit" size="small" @click="$router.push('/admin/liuyanban/updt?id='+row.id)">回复</el-button>
                                </el-tooltip>
...
<script setup>
    ...
    const loadList = (page) => {
        ...
        http.post("/api/liuyanban/selectZhanghao", search).then(
            (res) => {
                loading.value = false;
                if (res.code == 0) {
                    var data = res.data;

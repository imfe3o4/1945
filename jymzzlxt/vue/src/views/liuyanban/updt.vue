<template>
    <div class="views-liuyanban-updt">
        <div>
...
<script setup>
    ...
    import { useLiuyanbanFindById, canLiuyanbanFindById, canLiuyanbanUpdate, canYishengFindById } from "@/module";
    ...
    const form = useLiuyanbanFindById(props.id);

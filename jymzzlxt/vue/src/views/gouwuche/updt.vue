...
<script setup>
    ...
    import { useGouwucheFindById, canGouwucheFindById, canGouwucheUpdate, canYaopinFindById } from "@/module";
    ...
    const form = useGouwucheFindById(props.id);

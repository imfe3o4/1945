<template>
    <div class="views-shijuan-detail">
        <div>
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="时长"> {{ map.shichang }} </el-descriptions-item>
                        <el-descriptions-item label="试卷简介"> {{ map.shijuanjianjie }} </el-descriptions-item>
...
<script setup>
    ...
    import { useShijuanFindById, canShijuanFindById } from "@/module";

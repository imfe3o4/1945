...
<script setup>
    ...
    import { useShitiFindById, canShitiFindById, canShitiUpdate, canShijuanFindById } from "@/module";
    ...
    const form = useShitiFindById(props.id);

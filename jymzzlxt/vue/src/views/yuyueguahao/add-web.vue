<template>
    <div class="views-yuyueguahao-web-add">
        <div>
            <e-container>
                <el-card class="box-card">
                    ...
                    <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                        ...
                        <el-form-item
                            ...
                            prop="nianling"
                            required
                            :rules="[{required:true, message:'请填写年龄'}, {validator:rule.checkNumber, message:'输入一个有效数字'}]"
                        >
...
<script setup>
    ...
    import { useYuyueguahaoCreateForm, canYuyueguahaoInsert } from "@/module";
    ...
    const { form, readMap } = useYuyueguahaoCreateForm(props.id);
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canYuyueguahaoInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {

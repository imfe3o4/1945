<template>
    <div class="views-gerenjiankangshuju-add">
        <div>
...
<script setup>
    ...
    import { useGerenjiankangshujuCreateForm, canGerenjiankangshujuInsert } from "@/module";
    ...
    const { form } = useGerenjiankangshujuCreateForm();
        ...
        return new Promise((resolve, reject) => {
            formModel.value
                ...
                .then((res) => {
                    ...
                    loading.value = true;
                    canGerenjiankangshujuInsert(form).then(
                        (res) => {
                            loading.value = false;
                            if (res.code == 0) {

            ...
            <el-card class="box-card">
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="得分"> {{ map.defen }} </el-descriptions-item>
                        <el-descriptions-item label="字母"> {{ map.zimu }} </el-descriptions-item>
                    ...
                    <el-descriptions direction="vertical" class="margin-top" :column="1" border>
                        ...
                        <el-descriptions-item label="答案"> {{ map.daan }} </el-descriptions-item>
                    </el-descriptions>
                </div>
...
<script setup>
    ...
    import { useJieguoFindById, canJieguoFindById } from "@/module";
    ...
    const map = useJieguoFindById(props.id);

...
<script setup>
    ...
    import { useWenzhangFindById, canWenzhangFindById, canWenzhangUpdate } from "@/module";
    ...
    const form = useWenzhangFindById(props.id);

...
public class WenzhangService {
     ...
     *  根据id 获取一行数据
     */
    public R<Wenzhang> findById(Integer id) {
     ...
     *  根据Wrapper 对象进行数据筛选
     */
    public R<List<Wenzhang>> selectAll(Wrapper<Wenzhang> query) {
    ...
    public R<List<Wenzhang>> selectAll() {
        QueryWrapper<Wenzhang> wrapper = Wrappers.query();
    ...
    public R selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Wenzhang> wrapper = mapToWrapper(map);
        // 设置排序
     ...
     */
    public QueryWrapper<Wenzhang> mapToWrapper(Map<String, Object> map) {
        // 创建 QueryWrapper 对象
        QueryWrapper<Wenzhang> wrapper = Wrappers.query();
    ...
    public R selectPages(QueryWrapper<Wenzhang> wrapper, IPage page) {
     ...
     * @return 是否处理成功
     */
    public R insert(Wenzhang entityData, Map post) {
        // 判断是否有填写标题。
     ...
     * @return 是否处理成功
     */
    public R<Object> update(Wenzhang entityData, Map post) {
        // 判断是否有填写标题。
        if (StringUtil.isNullOrEmpty(post.get("biaoti"))) {
            return R.error("请填写标题");
        }

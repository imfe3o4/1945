...
public class LeibieService {
    ...
    // 获取数据库操作类mapper
    @Resource
    private LeibieMapper mapper;

    /**
     *  根据id 获取一行数据
     */
    public R<Leibie> findById(Integer id) {
     ...
     *  根据Wrapper 对象进行数据筛选
     */
    public R<List<Leibie>> selectAll(Wrapper<Leibie> query) {
    ...
    public R<List<Leibie>> selectAll() {
        QueryWrapper<Leibie> wrapper = Wrappers.query();
    ...
    public R selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Leibie> wrapper = mapToWrapper(map);
        // 设置排序
     ...
     */
    public QueryWrapper<Leibie> mapToWrapper(Map<String, Object> map) {
        // 创建 QueryWrapper 对象
        QueryWrapper<Leibie> wrapper = Wrappers.query();
        ...
        if (!StringUtil.isNullOrEmpty(map.get("leibiemingcheng"))) {
            wrapper.like("leibiemingcheng", map.get("leibiemingcheng"));
        }
    ...
    public R selectPages(QueryWrapper<Leibie> wrapper, IPage page) {
     ...
     * @return 是否处理成功
     */
    public R insert(Leibie entityData, Map post) {
     ...
     * @return 是否处理成功
     */
    public R<Object> update(Leibie entityData, Map post) {
